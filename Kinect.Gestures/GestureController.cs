...
namespace Kinect.Gestures
{
    public class GestureController
    {
        ...
        public DepthImagePoint LeftHandDepth;

        public DepthImagePoint RightHandDepth;
        ...
        public void UpdateAllGestures(Skeleton data, DepthImagePoint head ,DepthImagePoint leftHand, DepthImagePoint rightHand)
        {
            foreach (Gesture gesture in this.gestures)
            {
            gesture.UpdateGesture (data, head, leftHand, rightHand);
            }
        }
